...
public class HMMTraining {
	...
	static HiddenMarkovModel buildContHMM() {
		...
		hmm.setStateDistribution(0, new ContinousDistribution(mean1,
				covariance1));
		hmm.setStateDistribution(1, new ContinousDistribution(mean2,
				covariance2));
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Training Continuous Hidden Markov Model with Baum Welch");
